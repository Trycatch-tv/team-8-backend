...
urlpatterns=[
        ...
        path('estudiantes/<int:estudiante_id>/cursos/', CursosEstudianteView.as_view(), name='cursos_estudiante'),        
        ...
        path('profesor/<int:profesor_id>/cursos/', ProfesorCursosView.as_view(), name='cursos_profesores'),   
        path('profesores/<int:profesor_id>/estudiantes/', ProfesorEstudiantes.as_view(), name='estudiantes_profesores'),   
